    ...
    <>
      <div className="flex flex-col justify-evenly items-center m-auto shadow-md mt-11 h-[300px] mb-7 max-w-[400px]">
        ...
        <form
          ...
          className=" flex flex-col mb-6 w-full p-6   gap-5"
          action=""
        >
          <input
            className="outline-none border-solid pl-3 border-b"
            type="email"
            placeholder="email"
            name="email"
            value={email}
          ...
          <button
            className="bg-blue-600 text-white py-1.5 text-xl rounded-md cursor-pointer text-center mt-3"
            type="submit"
          >
            Login
          </button>
